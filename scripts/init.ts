...
/* Selected suggestion */
.suggestion-item.is-selected .wordserve-suggestion-container {
  background-color: var(--background-modifier-selected);
}

.suggestion-item.is-selected .wordserve-suggestion-rank {
  background-color: color-mix(in oklab, var(--text-normal), transparent 80%);
}

.suggestion-item.is-selected .wordserve-suggestion-container .suggestion-prefix {
  opacity: 0.8;
}

.suggestion-item.is-selected .wordserve-suggestion-container .suggestion-suffix {}

/* Prefix highlighting */
.wordserve-suggestion-container .suggestion-prefix {
  color: var(--text-faint);
}

.wordserve-suggestion-container .suggestion-suffix {
  color: var(--text-normal);
}
...
body.wordserve-bold-suffix .wordserve-suggestion-container .suggestion-suffix {
  font-weight: bold;
}
